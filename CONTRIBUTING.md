...
Set up the dev venv and run the gates:
...
`make dev` installs the sibling `tai-contract`, `tai-kit`, `tai-toolbox`, and `tai-identity-redis` repos as editable installs for local cross-repo development.
