...
environment (the embedded app serves no ``/metrics`` route — a reader over the
multiproc dir is yours to run), and process-fleet orchestration. Fleet config-reload fan-out is the app's internal
