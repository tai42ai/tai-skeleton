...
:class:`~tai_contract.versioning.VersionedStore`. The contract facet
``tai_app.versioning.store`` forwards TO this builder, so this function is the
...
from tai_skeleton.versioning.settings import VersioningStorePgSettings
