...
``tai_skeleton.operations.sub_mcp`` — no routing/build logic lives here. The POST
...
from tai_skeleton.app.sub_mcp_app import _VALID_TRANSPORTS
from tai_skeleton.operations import BadRequestError, operation_metadata_of, register_operation_route
from tai_skeleton.operations.sub_mcp import list_sub_mcp as _list_sub_mcp_op
from tai_skeleton.operations.sub_mcp import register_sub_mcp as _register_sub_mcp_op
from tai_skeleton.operations.sub_mcp import unregister_sub_mcp as _unregister_sub_mcp_op
