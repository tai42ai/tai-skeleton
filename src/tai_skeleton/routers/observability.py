...
monitoring READ contract (``tai_contract.monitoring``): aggregate metrics, a
...
adapters over operations in ``tai_skeleton.operations.observability``: the query
...
from tai_skeleton.operations.observability import get_metrics as _get_metrics_op
from tai_skeleton.operations.observability import get_run_trace as _get_run_trace_op
from tai_skeleton.operations.observability import list_observability_runs as _list_observability_runs_op
from tai_skeleton.routers.observability_support import (
    PAGE_CHUNK,
    RequestParseError,
    csv_safe,
    derive_run,
