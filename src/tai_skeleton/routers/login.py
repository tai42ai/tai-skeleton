...
``tai_skeleton.operations.login``. The logout candidates are HTTP-edge input —
...
from tai_skeleton.access_control.backend import extract_credential_candidates
from tai_skeleton.operations import operation_metadata_of, register_operation_route
from tai_skeleton.operations.login import exchange_claim_token as _exchange_claim_token_op
from tai_skeleton.operations.login import login_methods as _login_methods_op
from tai_skeleton.operations.login import logout as _logout_op
