...
AUTHED thin adapters over operations in ``tai_skeleton.operations.storage`` — a thin
skin over the registered :class:`~tai_contract.storage.Storage` provider (the app's
...
from tai_skeleton.operations.storage import delete_dir as _delete_dir_op
from tai_skeleton.operations.storage import delete_resource as _delete_resource_op
from tai_skeleton.operations.storage import list_resources as _list_resources_op
from tai_skeleton.operations.storage import stat_resource as _stat_resource_op
from tai_skeleton.operations.storage import storage_info as _storage_info_op
from tai_skeleton.operations.storage import upload_resource as _upload_resource_op
