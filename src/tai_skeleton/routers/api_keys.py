...
in :mod:`tai_skeleton.operations.api_keys`; no key/scope logic lives here:
...
from tai_skeleton.operations.api_keys import add_scope_url as _add_scope_url_op
from tai_skeleton.operations.api_keys import create_api_key as _create_api_key_op
from tai_skeleton.operations.api_keys import create_claim_link as _create_claim_link_op
from tai_skeleton.operations.api_keys import delete_scope as _delete_scope_op
from tai_skeleton.operations.api_keys import edit_api_key as _edit_api_key_op
from tai_skeleton.operations.api_keys import get_capabilities as _get_capabilities_op
from tai_skeleton.operations.api_keys import get_me as _get_me_op
from tai_skeleton.operations.api_keys import list_policy_versions as _list_policy_versions_op
from tai_skeleton.operations.api_keys import list_public_routes as _list_public_routes_op
from tai_skeleton.operations.api_keys import list_roles as _list_roles_op
from tai_skeleton.operations.api_keys import list_routes as _list_routes_op
from tai_skeleton.operations.api_keys import list_scopes as _list_scopes_op
from tai_skeleton.operations.api_keys import list_tokens_payload as _list_tokens_payload_op
from tai_skeleton.operations.api_keys import pin_public_route as _pin_public_route_op
from tai_skeleton.operations.api_keys import remove_scope_url as _remove_scope_url_op
from tai_skeleton.operations.api_keys import revoke_api_key as _revoke_api_key_op
from tai_skeleton.operations.api_keys import rollback_policy as _rollback_policy_op
from tai_skeleton.operations.api_keys import unpin_public_route as _unpin_public_route_op
from tai_skeleton.operations.api_keys import validate_condition as _validate_condition_op
...
list_scopes = register_operation_route(
    tai_app, operation_metadata_of(_list_scopes_op), path="/api/auth/scopes", method="GET"
)
...
delete_scope = register_operation_route(
    tai_app, operation_metadata_of(_delete_scope_op), path="/api/auth/scopes/{scope_id}", method="DELETE"
)
...
list_public_routes = register_operation_route(
    tai_app, operation_metadata_of(_list_public_routes_op), path="/api/auth/public-routes", method="GET"
)
...
list_tokens_payload = register_operation_route(
    tai_app, operation_metadata_of(_list_tokens_payload_op), path="/api/auth/tokens-payload", method="GET"
)
...
revoke_api_key = register_operation_route(
    tai_app, operation_metadata_of(_revoke_api_key_op), path="/api/auth/api-keys/{user_id}", method="DELETE"
)
...
get_capabilities = register_operation_route(
    tai_app, operation_metadata_of(_get_capabilities_op), path="/api/auth/capabilities", method="GET"
)
...
list_roles = register_operation_route(
    tai_app, operation_metadata_of(_list_roles_op), path="/api/auth/roles", method="GET"
)
