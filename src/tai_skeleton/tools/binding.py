...
from tai_contract.manifest import ExtensionElement, TaiMCPConfig

from tai_skeleton.agent.binding import _UNSET
from tai_skeleton.exceptions.exceptions import TaiValidationError
from tai_skeleton.extensions.registry import extension_config, extension_name, factory_accepts_config
from tai_skeleton.tools.adapters.lc_tool_to_func import lc_tool_to_func
from tai_skeleton.tools.context_bridge import bridge_context
...
# in ``sys.modules``.
MCP_VIRTUAL_MODULE_PREFIX = "tai_mcp_virtual."
...
class ToolBinding:
    ...
    def mcp_tools(self, config: TaiMCPConfig, tools) -> None:
        ...
        for t in tools:
            ...
            from tai_skeleton.tools.adapters.mcp_tool_to_func import mcp_tool_to_func
