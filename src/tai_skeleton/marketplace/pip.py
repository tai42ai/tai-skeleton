...
over the SSRF-guarded, size-capped :func:`tai_kit.net.fetch_url`, recomputes its
...
async def fetch_verified_artifact(package: str, version: str, artifact_ref: str, sha256: str, dest_dir: Path) -> Path:
    ...
    :func:`tai_kit.net.fetch_url` and their recomputed sha256 is compared,
    ...
    unparseable URL), a :class:`tai_kit.net.UrlGuardError` (an SSRF/size/redirect
