...
:class:`~tai_skeleton.cli.context.AppContext` on the Typer context (for a
configured client), :class:`~tai_skeleton.cli.client.ApiClient`, and the
:mod:`tai_skeleton.cli.render` helpers.
"""
...
from tai_skeleton.cli.commands import (
    agents,
    auth,
    backup,
    channels,
...
from tai_skeleton.cli.native import catalog, completion, db, doctor, openapi, version
...
cli_app = typer.Typer(
    name="tai",
    cls=TaiCLIGroup,
    help="Operate a tai-skeleton server from the terminal.",
