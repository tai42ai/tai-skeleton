...
:class:`~tai_skeleton.marketplace.installer.Installer`.

The internal :class:`~tai_skeleton.marketplace.errors.MarketplaceError` family is
...
own author error — a typed :class:`~tai_skeleton.marketplace.errors.MalformedRefError`
