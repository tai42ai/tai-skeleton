...
through the single :class:`~tai_skeleton.config.service.ConfigService` pipeline: the
...
The concrete app singleton (``from tai_skeleton.app import instance``) is reached
...
from tai_skeleton.operations._broadcast import apply_response
