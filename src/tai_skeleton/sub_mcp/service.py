...
from tai_skeleton.app.sub_mcp_app import validate_registration
...
async def register_sub_mcp_app(slug: str, tools: list[str], transport: str = "http") -> None:
    ...
    await tai_app.sub_app.mcp_sub_app_router.register_sub_mcp_app(slug, tools, transport=transport)
...
async def unregister_sub_mcp_app(slug: str) -> bool:
    ...
    router = tai_app.sub_app.mcp_sub_app_router
