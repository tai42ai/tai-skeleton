...
under the generic :class:`~tai_contract.versioning.VersionedStore` as ``kind="role"``
— a third view mirroring :class:`~tai_skeleton.access_control.policy_store.AcPolicyStore`
and :class:`~tai_skeleton.presets.store.PresetStoreView`.
...
from tai_contract.versioning.errors import DocumentExistsError, DocumentNotFoundError
